...
Electrical safety covers practical jobsite controls for temporary power, overhead lines, energized equipment, cords, panels, gfci use, and electrical hazard controls. This page is written for field use and does not replace WorkSafeBC, BC law, engineered documents, manufacturer instructions, or site-specific procedures.
