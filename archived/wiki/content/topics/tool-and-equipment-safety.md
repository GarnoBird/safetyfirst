...
Tool and equipment safety covers practical jobsite controls for hand tools, power tools, guards, cords, maintenance, inspection, and safe use. This page is written for field use and does not replace WorkSafeBC, BC law, engineered documents, manufacturer instructions, or site-specific procedures.
