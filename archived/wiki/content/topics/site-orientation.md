...
Site orientation covers practical jobsite controls for worker onboarding to site-specific hazards, rules, emergency information, and required training checks. This page is written for field use and does not replace WorkSafeBC, BC law, engineered documents, manufacturer instructions, or site-specific procedures.
...
- New worker risk
- Unknown emergency procedure
- Missed high-risk work rule
