...
Emergency response covers practical jobsite controls for site response to fire, collapse, medical emergency, rescue, spill, evacuation, severe weather, and external emergency services. This page is written for field use and does not replace WorkSafeBC, BC law, engineered documents, manufacturer instructions, or site-specific procedures.
