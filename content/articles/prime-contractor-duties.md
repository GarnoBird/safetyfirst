...
Use this page when site coordination, subcontractor coordination, project startup could involve hazards or outcomes such as uncoordinated work, overlapping trades, public interface. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Prime Contractor Duties usually connects to other site controls, not just one task. Read it with [[employer-duties|Employer Duties]] and [[supervisor-duties|Supervisor Duties]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising site coordination, subcontractor coordination, project startup, and this topic affects the task. {{cite:ohsr-part-20}}
- The work could involve hazards or outcomes such as uncoordinated work, overlapping trades, public interface, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[worker-rights-and-responsibilities|Worker Rights and Responsibilities]].
...
- Prime contractor designation or coordination record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Site-specific safety plan: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-20}}
- Emergency response plan: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-regulation}}
- Inspection and corrective action records: shows workers received task-specific instruction before doing the work. {{cite:workers-compensation-act}}
...
2. Read [[employer-duties|Employer Duties]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including uncoordinated work, overlapping trades, public interface, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[ohs-program|OHS Program]] and assign a separate corrective action.
