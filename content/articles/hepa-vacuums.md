...
Use this page when concrete drilling, grinding, cleanup, lead work, silica work could involve hazards or outcomes such as respirable dust, silica, lead dust, asbestos fibres, filter bypass. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

HEPA Vacuums usually connects to other site controls, not just one task. Read it with [[dust-control-methods|Dust Control Methods]] and [[silica-exposure-control|Silica Exposure Control]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising concrete drilling, grinding, cleanup, lead work, silica work, and this topic affects the task. {{cite:ohsr-part-6}}
- The work could involve hazards or outcomes such as respirable dust, silica, lead dust, asbestos fibres, filter bypass, even if the trade or location is different.
...
- A required document such as exposure control plan must be prepared, reviewed, updated, or kept available.
...
- Stop and reassess the work when conditions no longer match the plan, a control is missing, or a worker reports an unsafe condition. {{cite:worksafebc-silica}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[wet-cutting|Wet Cutting]].
...
- Exposure control plan: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-5}}
- Vacuum inspection/maintenance record: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-6}}
- Filter change procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-8}}
- Waste disposal procedure: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Worker instruction record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-silica}}
- Site-specific safe work procedure: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-asbestos}}
...
2. Read [[dust-control-methods|Dust Control Methods]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including respirable dust, silica, lead dust, asbestos fibres, filter bypass, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including exposure control plan.
...
- [ ] I know the main hazards: respirable dust, silica, lead dust, asbestos fibres, filter bypass.
...
- [ ] If the deficiency points to a broader issue, open [[lead-exposure-control|Lead Exposure Control]] and assign a separate corrective action.
