...
Use this page when committee meetings, inspections, incident review, recommendations could involve hazards or outcomes such as weak worker participation, missed hazards, untracked recommendations. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

JHSC Requirements usually connects to other site controls, not just one task. Read it with [[worker-rights-and-responsibilities|Worker Rights and Responsibilities]] and [[workplace-inspections|Workplace Inspections]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising committee meetings, inspections, incident review, recommendations, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as weak worker participation, missed hazards, untracked recommendations, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[incident-investigation|Incident Investigation]].
...
- Committee member list: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Meeting minutes: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Inspection reports: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:workers-compensation-act}}
- Recommendation and response records: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-jhsc}}
- Committee training records: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-guidelines}}
- Site-specific safe work procedure: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:ohsr-part-3}}
...
- Inspection or pre-use check record: creates evidence for the next scheduled safety/source review. {{cite:workers-compensation-act}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[worker-rights-and-responsibilities|Worker Rights and Responsibilities]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including weak worker participation, missed hazards, untracked recommendations, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[corrective-actions|Corrective Actions]] and assign a separate corrective action.
