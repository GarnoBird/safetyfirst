...
Use this page when emergency response, site orientation, fire planning could involve hazards or outcomes such as fire, collapse, gas release, medical emergency, blocked exit. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Evacuation usually connects to other site controls, not just one task. Read it with [[site-emergency-response-plan|Site Emergency Response Plan]] and [[fire-prevention-plan|Fire Prevention Plan]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-32}}

## When this applies

- You are planning or supervising emergency response, site orientation, fire planning, and this topic affects the task. {{cite:ohsr-part-4}}
- The work could involve hazards or outcomes such as fire, collapse, gas release, medical emergency, blocked exit, even if the trade or location is different.
...
- Evacuation procedure: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-32}}
- Muster location map: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-4}}
- Emergency contact list: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-20}}
- Drill or review record: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: keeps the field procedure tied to official sources instead of memory or habit. {{cite:bc-building-code}}
...
3. List the hazards and possible outcomes, including fire, collapse, gas release, medical emergency, blocked exit, and identify everyone who could be affected.
