...
Use this page when this work could involve hazards or outcomes such as struck-by, rollover, crushing, backing incidents. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Mobile Equipment usually connects to other site controls, not just one task. Read it with [[traffic-control|Traffic Control]] and [[excavation-and-trenching|Excavation and Trenching]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-16}}

## When this applies

- You are planning or supervising this work, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as struck-by, rollover, crushing, backing incidents, even if the trade or location is different.
...
- A required document such as pre-use inspection must be prepared, reviewed, updated, or kept available.
- A worker is new to the task, unfamiliar with the site, or unsure which control applies.

## Legal requirements

- Confirm the applicable WorkSafeBC OHS Regulation part, guideline, policy, and any Workers Compensation Act duty before directing the work. {{cite:ohsr-part-16}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[cranes-and-hoists|Cranes and Hoists]].
...
- Pre-use inspection: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-16}}
- Operator record: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Traffic control plan where required: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-guidelines}}
- Site-specific safe work procedure: shows workers received task-specific instruction before doing the work. {{cite:ohsr-part-16}}
- Worker instruction or training record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-regulation}}
...
- Corrective action record when a deficiency is found: gives the crew a reference point when conditions change mid-shift. {{cite:ohsr-part-16}}
...
3. List the hazards and possible outcomes, including struck-by, rollover, crushing, backing incidents, and identify everyone who could be affected.
4. Confirm the official source, owner/client requirement, manufacturer instruction, and site rule that apply. {{cite:ohsr-part-16}}
5. Prepare or update the required document set, including pre-use inspection.
...
- [ ] I know the main hazards: struck-by, rollover, crushing, backing incidents.
...
- [ ] If the deficiency points to a broader issue, open [[site-specific-safety-plan|Site-Specific Safety Plan]] and assign a separate corrective action.
