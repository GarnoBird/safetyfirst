...
Use this page when pre-job planning, task supervision, hazard correction could involve hazards or outcomes such as unsafe work direction, uncorrected hazards, inadequate instruction. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Supervisor Duties usually connects to other site controls, not just one task. Read it with [[employer-duties|Employer Duties]] and [[worker-rights-and-responsibilities|Worker Rights and Responsibilities]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising pre-job planning, task supervision, hazard correction, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as unsafe work direction, uncorrected hazards, inadequate instruction, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[toolbox-talks|Toolbox Talks]].
...
- Supervisor inspection notes: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Toolbox talk or pre-job briefing record: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
...
- Training or competency records: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-rights-responsibilities}}
...
- Corrective action record when a deficiency is found: creates evidence for the next scheduled safety/source review. {{cite:workers-compensation-act}}
...
3. List the hazards and possible outcomes, including unsafe work direction, uncorrected hazards, inadequate instruction, and identify everyone who could be affected.
