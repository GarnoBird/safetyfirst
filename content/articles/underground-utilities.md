...
Use this page when excavation, drilling, trenching, utility crossing, concrete coring could involve hazards or outcomes such as electric shock, gas release, explosion, flooding, service strike. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Underground Utilities usually connects to other site controls, not just one task. Read it with [[excavation-and-trenching|Excavation and Trenching]] and [[excavation-spoil-piles|Excavation Spoil Piles]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising excavation, drilling, trenching, utility crossing, concrete coring, and this topic affects the task. {{cite:ohsr-part-19}}
- The work could involve hazards or outcomes such as electric shock, gas release, explosion, flooding, service strike, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[site-emergency-response-plan|Site Emergency Response Plan]].
...
- Utility locate records: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-20}}
- Owner requirements/instructions: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-19}}
- Excavation plan: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-32}}
- Hand expose/daylighting record where required: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Emergency response plan: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-guidelines}}
- Site-specific safe work procedure: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:ohsr-part-20}}
...
2. Read [[excavation-and-trenching|Excavation and Trenching]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including electric shock, gas release, explosion, flooding, service strike, and identify everyone who could be affected.
