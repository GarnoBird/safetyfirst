...
hazards:
  - "Unreported regulated project"
  - "Missing project startup controls"
tasks:
  - "Project startup"
...
Use this page when project startup, tower crane activity, construction planning could involve hazards or outcomes such as unreported regulated project, missing project startup controls. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Notice of Project usually connects to other site controls, not just one task. Read it with [[prime-contractor-duties|Prime Contractor Duties]] and [[ohs-program|OHS Program]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising project startup, tower crane activity, construction planning, and this topic affects the task. {{cite:ohsr-part-14}}
- The work could involve hazards or outcomes such as unreported regulated project, missing project startup controls, even if the trade or location is different.
...
- A required document such as submitted notice of project where required must be prepared, reviewed, updated, or kept available.
...
- Use required written plans, procedures, inspections, permits, assessments, or records when the cited source or site condition calls for them. {{cite:worksafebc-notice-project}}
...
- Submitted Notice of Project where required: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-20}}
- Project details used for submission: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-14}}
- Updated notice if key project information changes: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-notice-project}}
- Worker instruction or training record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:workers-compensation-act}}
...
3. List the hazards and possible outcomes, including unreported regulated project, missing project startup controls, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including submitted notice of project where required.
...
- [ ] I know the main hazards: unreported regulated project, missing project startup controls.
...
- {{cite:worksafebc-notice-project}}
