...
Use this page when concrete cutting, coring, masonry cutting, tile cutting, grinding could involve hazards or outcomes such as silica dust, slurry, electrical shock, slip hazard, overspray. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Wet Cutting usually connects to other site controls, not just one task. Read it with [[silica-exposure-control|Silica Exposure Control]] and [[dust-control-methods|Dust Control Methods]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising concrete cutting, coring, masonry cutting, tile cutting, grinding, and this topic affects the task. {{cite:ohsr-part-6}}
- The work could involve hazards or outcomes such as silica dust, slurry, electrical shock, slip hazard, overspray, even if the trade or location is different.
...
- A required document such as silica exposure control plan must be prepared, reviewed, updated, or kept available.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-6}}
...
- Coordinate the work with the prime contractor, employer, supervisor, affected workers, and nearby trades where overlapping work can create hazards. {{cite:worksafebc-silica}}
...
- Silica exposure control plan: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-5}}
- Wet cutting procedure: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-6}}
- Slurry cleanup/disposal procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-8}}
- Electrical/GFCI setup check where applicable: shows workers received task-specific instruction before doing the work. {{cite:ohsr-part-19}}
- Respirator fit test/training record where required: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-silica}}
...
- Inspection or pre-use check record: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-5}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[silica-exposure-control|Silica Exposure Control]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including silica dust, slurry, electrical shock, slip hazard, overspray, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including silica exposure control plan.
...
- [ ] I know the main hazards: silica dust, slurry, electrical shock, slip hazard, overspray.
...
- [ ] If the deficiency points to a broader issue, open [[ventilation|Ventilation]] and assign a separate corrective action.
