...
Use this page when roofing, membrane work, roof access, material staging could involve hazards or outcomes such as falls from height, fragile surfaces, weather exposure, material handling. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Roof Work usually connects to other site controls, not just one task. Read it with [[fall-protection|Fall Protection]] and [[guardrails|Guardrails]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising roofing, membrane work, roof access, material staging, and this topic affects the task. {{cite:ohsr-part-20}}
- The work could involve hazards or outcomes such as falls from height, fragile surfaces, weather exposure, material handling, even if the trade or location is different.
...
- Provide workers with the information, instruction, training, supervision, PPE, and equipment needed for the task. {{cite:ohsr-part-13}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[fall-restraint|Fall Restraint]].
...
- Fall protection plan: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-11}}
- Roof access plan: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-20}}
- Rescue plan: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-13}}
- Weather and surface condition check: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
...
3. List the hazards and possible outcomes, including falls from height, fragile surfaces, weather exposure, material handling, and identify everyone who could be affected.
...
- [ ] I know the main hazards: falls from height, fragile surfaces, weather exposure, material handling.
...
- [ ] If the deficiency points to a broader issue, open [[fall-rescue-plan|Fall Rescue Plan]] and assign a separate corrective action.
