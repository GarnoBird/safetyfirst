...
Use this page when this work could involve hazards or outcomes such as falls from height, collapse, falling objects. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Scaffolds usually connects to other site controls, not just one task. Read it with [[fall-protection|Fall Protection]] and [[guardrails|Guardrails]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- The work could involve hazards or outcomes such as falls from height, collapse, falling objects, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[ladders|Ladders]].
...
- Scaffold inspection record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-13}}
- Manufacturer or engineering instructions: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
...
3. List the hazards and possible outcomes, including falls from height, collapse, falling objects, and identify everyone who could be affected.
