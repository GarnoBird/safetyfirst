...
hazards:
  ...
  - "Unsafe reassignment"
tasks:
  - "Unsafe task reporting"
  - "Supervisor investigation"
  - "Work refusal follow-up"
requiredDocuments:
...
Use this page when unsafe task reporting, supervisor investigation, work refusal follow-up could involve hazards or outcomes such as undue hazard, retaliation risk, unsafe reassignment. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Refusal of Unsafe Work usually connects to other site controls, not just one task. Read it with [[worker-rights-and-responsibilities|Worker Rights and Responsibilities]] and [[supervisor-duties|Supervisor Duties]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising unsafe task reporting, supervisor investigation, work refusal follow-up, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as undue hazard, retaliation risk, unsafe reassignment, even if the trade or location is different.
...
- A required document such as unsafe work refusal record must be prepared, reviewed, updated, or kept available.
...
- Use required written plans, procedures, inspections, permits, assessments, or records when the cited source or site condition calls for them. {{cite:worksafebc-refusing-unsafe-work}}
- Stop and reassess the work when conditions no longer match the plan, a control is missing, or a worker reports an unsafe condition. {{cite:worksafebc-rights-responsibilities}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[corrective-actions|Corrective Actions]].
...
- Unsafe work refusal record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Investigation notes: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Corrective action record: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:workers-compensation-act}}
- Written notice if another worker is assigned to the refused work: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-refusing-unsafe-work}}
- Site-specific safe work procedure: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-rights-responsibilities}}
...
3. List the hazards and possible outcomes, including undue hazard, retaliation risk, unsafe reassignment, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including unsafe work refusal record.
...
- [ ] I know the main hazards: undue hazard, retaliation risk, unsafe reassignment.
...
- [ ] If the deficiency points to a broader issue, open [[incident-investigation|Incident Investigation]] and assign a separate corrective action.
...
- {{cite:worksafebc-refusing-unsafe-work}}
