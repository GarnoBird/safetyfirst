...
Use this page when lane closure, delivery control, roadside work, pedestrian detour could involve hazards or outcomes such as vehicle strike, poor visibility, driver confusion, communication failure. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Traffic Control Persons usually connects to other site controls, not just one task. Read it with [[traffic-control|Traffic Control]] and [[traffic-control-plans|Traffic Control Plans]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-18}}

## When this applies

- You are planning or supervising lane closure, delivery control, roadside work, pedestrian detour, and this topic affects the task. {{cite:ohsr-part-8}}
- The work could involve hazards or outcomes such as vehicle strike, poor visibility, driver confusion, communication failure, even if the trade or location is different.
...
- A required document such as tcp training record must be prepared, reviewed, updated, or kept available.
...
- Use required written plans, procedures, inspections, permits, assessments, or records when the cited source or site condition calls for them. {{cite:worksafebc-traffic-training}}
...
- Coordinate the work with the prime contractor, employer, supervisor, affected workers, and nearby trades where overlapping work can create hazards. {{cite:ohsr-part-18}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[high-visibility-apparel|High Visibility Apparel]].
...
- TCP training record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-18}}
- Traffic control plan: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-8}}
- Orientation/site briefing record: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-regulation}}
- Inspection or supervisor review notes: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-traffic-training}}
...
- Worker instruction or training record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:ohsr-part-18}}
...
2. Read [[traffic-control|Traffic Control]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including vehicle strike, poor visibility, driver confusion, communication failure, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including tcp training record.
...
- [ ] I know the main hazards: vehicle strike, poor visibility, driver confusion, communication failure.
...
- [ ] If the deficiency points to a broader issue, open [[mobile-equipment|Mobile Equipment]] and assign a separate corrective action.
...
- {{cite:worksafebc-traffic-training}}
