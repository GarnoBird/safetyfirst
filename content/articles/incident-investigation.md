...
Use this page when this work could involve hazards or outcomes such as recurring incidents, uncorrected hazards. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Incident Investigation usually connects to other site controls, not just one task. Read it with [[workplace-inspections|Workplace Inspections]] and [[corrective-actions|Corrective Actions]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- The work could involve hazards or outcomes such as recurring incidents, uncorrected hazards, even if the trade or location is different.
...
- A required document such as incident report must be prepared, reviewed, updated, or kept available.
...
- Incident report: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Investigation record: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Corrective action log: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-guidelines}}
...
3. List the hazards and possible outcomes, including recurring incidents, uncorrected hazards, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including incident report.
...
- [ ] I know the main hazards: recurring incidents, uncorrected hazards.
...
- [ ] If the deficiency points to a broader issue, open [[worker-rights-and-responsibilities|Worker Rights and Responsibilities]] and assign a separate corrective action.
