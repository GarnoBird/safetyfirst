...
Use this page when onboarding, task assignment, competency tracking could involve hazards or outcomes such as unverified competency, expired tickets, missing instruction. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Training Records usually connects to other site controls, not just one task. Read it with [[site-orientation|Site Orientation]] and [[young-new-worker-orientation|Young/New Worker Orientation]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising onboarding, task assignment, competency tracking, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as unverified competency, expired tickets, missing instruction, even if the trade or location is different.
...
- Orientation and training records: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Equipment competency records: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Certificate or ticket copies where applicable: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-young-new-workers}}
- Refresher schedule: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-rights-responsibilities}}
...
- Corrective action record when a deficiency is found: creates evidence for the next scheduled safety/source review. {{cite:worksafebc-young-new-workers}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[site-orientation|Site Orientation]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including unverified competency, expired tickets, missing instruction, and identify everyone who could be affected.
