...
Use this page when grinding, cutting, welding, concrete work, chemical handling could involve hazards or outcomes such as flying particles, chemical splash, dust, uv/arc radiation, concrete slurry. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Eye and Face Protection usually connects to other site controls, not just one task. Read it with [[ppe-basics|PPE Basics]] and [[welding-and-cutting|Welding and Cutting]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising grinding, cutting, welding, concrete work, chemical handling, and this topic affects the task. {{cite:ohsr-part-5}}
- The work could involve hazards or outcomes such as flying particles, chemical splash, dust, uv/arc radiation, concrete slurry, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[power-tools|Power Tools]].
...
- PPE hazard assessment or procedure: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-8}}
- Worker instruction record: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-5}}
- Manufacturer instructions: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-12}}
...
3. List the hazards and possible outcomes, including flying particles, chemical splash, dust, uv/arc radiation, concrete slurry, and identify everyone who could be affected.
...
- [ ] I know the main hazards: flying particles, chemical splash, dust, uv/arc radiation, concrete slurry.
...
- [ ] If the deficiency points to a broader issue, open [[powder-actuated-tools|Powder-Actuated Tools]] and assign a separate corrective action.
