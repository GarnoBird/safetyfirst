...
Use this page when scaffold erection, scaffold use, daily inspection, alteration review could involve hazards or outcomes such as falls from height, scaffold collapse, falling objects, poor access. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Scaffold Inspection usually connects to other site controls, not just one task. Read it with [[scaffolds|Scaffolds]] and [[work-platforms|Work Platforms]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising scaffold erection, scaffold use, daily inspection, alteration review, and this topic affects the task. {{cite:ohsr-part-11}}
- The work could involve hazards or outcomes such as falls from height, scaffold collapse, falling objects, poor access, even if the trade or location is different.
...
- Scaffold inspection checklist: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-13}}
- Scaffold tag or status marker where used: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-11}}
- Manufacturer or engineering instructions: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-4}}
- Corrective action record: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
...
- Corrective action record when a deficiency is found: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-11}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[scaffolds|Scaffolds]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including falls from height, scaffold collapse, falling objects, poor access, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[fall-protection|Fall Protection]] and assign a separate corrective action.
