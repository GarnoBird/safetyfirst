...
Use this page when this work could involve hazards or outcomes such as falls from height, access/egress. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Ladders usually connects to other site controls, not just one task. Read it with [[fall-protection|Fall Protection]] and [[scaffolds|Scaffolds]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- The work could involve hazards or outcomes such as falls from height, access/egress, even if the trade or location is different.
...
- Inspection record where required: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-13}}
...
3. List the hazards and possible outcomes, including falls from height, access/egress, and identify everyone who could be affected.
...
- [ ] I know the main hazards: falls from height, access/egress.
