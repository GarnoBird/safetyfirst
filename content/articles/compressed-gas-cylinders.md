...
Use this page when welding, cutting, temporary heating, cylinder transport, storage could involve hazards or outcomes such as explosion, fire, projectile, gas leak, asphyxiation. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Compressed Gas Cylinders usually connects to other site controls, not just one task. Read it with [[welding-and-cutting|Welding and Cutting]] and [[hot-work|Hot Work]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising welding, cutting, temporary heating, cylinder transport, storage, and this topic affects the task. {{cite:ohsr-part-12}}
- The work could involve hazards or outcomes such as explosion, fire, projectile, gas leak, asphyxiation, even if the trade or location is different.
...
- A required document such as cylinder storage/handling procedure must be prepared, reviewed, updated, or kept available.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[fire-prevention-plan|Fire Prevention Plan]].
...
- Cylinder storage/handling procedure: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-5}}
- SDS where applicable: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-12}}
- Hot work procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-4}}
- Inspection record where required: shows workers received task-specific instruction before doing the work. {{cite:ohsr-part-32}}
...
2. Read [[welding-and-cutting|Welding and Cutting]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including explosion, fire, projectile, gas leak, asphyxiation, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including cylinder storage/handling procedure.
...
- [ ] I know the main hazards: explosion, fire, projectile, gas leak, asphyxiation.
...
- [ ] The article and official sources have been checked for this task. {{cite:ohsr-part-12}}
...
- [ ] If the deficiency points to a broader issue, open [[whmis-basics|WHMIS Basics]] and assign a separate corrective action.
