...
Use this page when site setup, power distribution, tool use, temporary lighting could involve hazards or outcomes such as electrical shock, fire, damaged cords, wet conditions, trip hazards. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Temporary Power usually connects to other site controls, not just one task. Read it with [[electrical-safety-near-power-lines|Electrical Safety Near Power Lines]] and [[de-energization|De-Energization]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising site setup, power distribution, tool use, temporary lighting, and this topic affects the task. {{cite:ohsr-part-10}}
- The work could involve hazards or outcomes such as electrical shock, fire, damaged cords, wet conditions, trip hazards, even if the trade or location is different.
...
- A required document such as temporary power plan or layout must be prepared, reviewed, updated, or kept available.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-10}}
- Provide workers with the information, instruction, training, supervision, PPE, and equipment needed for the task. {{cite:ohsr-part-4}}
...
- Use required written plans, procedures, inspections, permits, assessments, or records when the cited source or site condition calls for them. {{cite:ohsr-part-12}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[lockout|Lockout]].
...
- Temporary power plan or layout: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-19}}
- Inspection record: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-10}}
- Electrical permit/qualified worker documentation where required: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-4}}
- Lockout/de-energization procedure where required: shows workers received task-specific instruction before doing the work. {{cite:ohsr-part-12}}
...
- Worker instruction or training record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-high-voltage}}
...
- Corrective action record when a deficiency is found: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-19}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[electrical-safety-near-power-lines|Electrical Safety Near Power Lines]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including electrical shock, fire, damaged cords, wet conditions, trip hazards, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including temporary power plan or layout.
...
- [ ] I know the main hazards: electrical shock, fire, damaged cords, wet conditions, trip hazards.
...
- [ ] The article and official sources have been checked for this task. {{cite:ohsr-part-10}}
...
- [ ] If the deficiency points to a broader issue, open [[power-tools|Power Tools]] and assign a separate corrective action.
