...
Use this page when this work could involve hazards or outcomes such as falls from height. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Fall Restraint usually connects to other site controls, not just one task. Read it with [[fall-protection|Fall Protection]] and [[anchor-points|Anchor Points]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- The work could involve hazards or outcomes such as falls from height, even if the trade or location is different.
...
- A required document such as equipment inspection record must be prepared, reviewed, updated, or kept available.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[guardrails|Guardrails]].
...
- Equipment inspection record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-11}}
- Training/instruction record: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-guidelines}}
...
- Inspection or pre-use check record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-regulation}}
- Corrective action record when a deficiency is found: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-ohs-guidelines}}
...
3. List the hazards and possible outcomes, including falls from height, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including equipment inspection record.
...
- [ ] I know the main hazards: falls from height.
...
- [ ] If the deficiency points to a broader issue, open [[fall-arrest|Fall Arrest]] and assign a separate corrective action.
