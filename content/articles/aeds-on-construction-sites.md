...
- You are planning or supervising emergency response, first aid planning, site orientation, and this topic affects the task. {{cite:ohsr-part-32}}
- The work could involve hazards or outcomes such as cardiac arrest, delayed defibrillation, unknown aed location, even if the trade or location is different.
...
- AED inspection record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- AED location map: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-32}}
- Emergency response procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-regulation}}
- First aid assessment note: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-first-aid-requirements}}
- Site-specific safe work procedure: keeps the field procedure tied to official sources instead of memory or habit. {{cite:heart-stroke-cpr}}
...
3. List the hazards and possible outcomes, including cardiac arrest, delayed defibrillation, unknown aed location, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[first-aid-room|First Aid Room]] and assign a separate corrective action.
