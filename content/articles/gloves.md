...
Use this page when material handling, concrete work, chemical handling, welding, power tool use could involve hazards or outcomes such as cuts, chemical burns, concrete burns, heat/cold, entanglement. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Gloves usually connects to other site controls, not just one task. Read it with [[ppe-basics|PPE Basics]] and [[whmis-basics|WHMIS Basics]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising material handling, concrete work, chemical handling, welding, power tool use, and this topic affects the task. {{cite:ohsr-part-5}}
- The work could involve hazards or outcomes such as cuts, chemical burns, concrete burns, heat/cold, entanglement, even if the trade or location is different.
...
- Use required written plans, procedures, inspections, permits, assessments, or records when the cited source or site condition calls for them. {{cite:worksafebc-ppe}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[material-handling|Material Handling]].
...
- SDS or manufacturer glove compatibility where chemicals are used: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-5}}
...
- Site-specific safe work procedure: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ppe}}
...
- Inspection or pre-use check record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:ohsr-part-8}}
...
3. List the hazards and possible outcomes, including cuts, chemical burns, concrete burns, heat/cold, entanglement, and identify everyone who could be affected.
...
- [ ] I know the main hazards: cuts, chemical burns, concrete burns, heat/cold, entanglement.
...
- [ ] If the deficiency points to a broader issue, open [[welding-and-cutting|Welding and Cutting]] and assign a separate corrective action.
