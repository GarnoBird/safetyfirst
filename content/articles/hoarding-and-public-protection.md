...
Use this page when site setup, demolition, overhead work, traffic/public interface could involve hazards or outcomes such as public exposure, falling objects, traffic interface, unauthorized access, dust/noise. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Hoarding and Public Protection usually connects to other site controls, not just one task. Read it with [[traffic-control|Traffic Control]] and [[traffic-control-plans|Traffic Control Plans]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising site setup, demolition, overhead work, traffic/public interface, and this topic affects the task. {{cite:ohsr-part-4}}
- The work could involve hazards or outcomes such as public exposure, falling objects, traffic interface, unauthorized access, dust/noise, even if the trade or location is different.
...
- Public protection plan: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-20}}
- Traffic/pedestrian control plan where required: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-4}}
- Hoarding inspection record: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-18}}
- Municipal/permit requirements where applicable: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
...
3. List the hazards and possible outcomes, including public exposure, falling objects, traffic interface, unauthorized access, dust/noise, and identify everyone who could be affected.
