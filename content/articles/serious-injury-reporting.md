...
Use this page when emergency response, incident notification, scene protection could involve hazards or outcomes such as delayed reporting, scene disturbance, repeat incident. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Serious Injury Reporting usually connects to other site controls, not just one task. Read it with [[incident-investigation|Incident Investigation]] and [[corrective-actions|Corrective Actions]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising emergency response, incident notification, scene protection, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as delayed reporting, scene disturbance, repeat incident, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[occupational-first-aid-requirements|Occupational First Aid Requirements]].
...
- Emergency report record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Incident investigation record: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Scene preservation notes: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:workers-compensation-act}}
- Corrective action log: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-serious-incident-reporting}}
...
2. Read [[incident-investigation|Incident Investigation]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including delayed reporting, scene disturbance, repeat incident, and identify everyone who could be affected.
