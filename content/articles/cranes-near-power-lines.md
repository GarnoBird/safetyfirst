...
Use this page when crane lift, boom truck work, concrete pumping, hoisting near lines could involve hazards or outcomes such as electrocution, arc flash, power line contact, step potential, boom/load contact. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Cranes Near Power Lines usually connects to other site controls, not just one task. Read it with [[cranes-and-hoists|Cranes and Hoists]] and [[lift-plans|Lift Plans]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-19}}

## When this applies

- You are planning or supervising crane lift, boom truck work, concrete pumping, hoisting near lines, and this topic affects the task. {{cite:ohsr-part-14}}
- The work could involve hazards or outcomes such as electrocution, arc flash, power line contact, step potential, boom/load contact, even if the trade or location is different.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-14}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[electrical-safety-near-power-lines|Electrical Safety Near Power Lines]].
...
- Power line hazard assessment: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-19}}
- Lift plan: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-14}}
- Utility confirmation/assurance where required: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-15}}
- Spotter or limits-of-approach procedure: shows workers received task-specific instruction before doing the work. {{cite:ohsr-part-32}}
- Emergency response procedure: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-high-voltage}}
...
- Inspection or pre-use check record: creates evidence for the next scheduled safety/source review. {{cite:worksafebc-ohs-guidelines}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[cranes-and-hoists|Cranes and Hoists]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including electrocution, arc flash, power line contact, step potential, boom/load contact, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[crane-operator-signaller-responsibilities|Crane Operator/Signaller Responsibilities]] and assign a separate corrective action.
