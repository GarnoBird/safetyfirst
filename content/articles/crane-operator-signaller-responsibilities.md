...
Use this page when hoisting, rigging, crane operation, signalling could involve hazards or outcomes such as dropped load, miscommunication, crushing, power line contact, blind lift. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Crane Operator/Signaller Responsibilities usually connects to other site controls, not just one task. Read it with [[cranes-and-hoists|Cranes and Hoists]] and [[rigging-basics|Rigging Basics]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-14}}

## When this applies

- You are planning or supervising hoisting, rigging, crane operation, signalling, and this topic affects the task. {{cite:ohsr-part-15}}
- The work could involve hazards or outcomes such as dropped load, miscommunication, crushing, power line contact, blind lift, even if the trade or location is different.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-15}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[lift-plans|Lift Plans]].
...
- Operator certification/qualification records: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-14}}
- Signaller/rigger competency record: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-15}}
- Lift plan: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-regulation}}
- Communication plan: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-crane-operator-competency}}
- Pre-lift briefing record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-crane-lift-planning}}
...
- Inspection or pre-use check record: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-15}}
...
3. List the hazards and possible outcomes, including dropped load, miscommunication, crushing, power line contact, blind lift, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[cranes-near-power-lines|Cranes Near Power Lines]] and assign a separate corrective action.
