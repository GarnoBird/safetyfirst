...
Use this page when electrical work, maintenance, temporary power changes, equipment repair could involve hazards or outcomes such as electrical shock, stored energy, pressure release, unexpected motion. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

De-Energization usually connects to other site controls, not just one task. Read it with [[lockout|Lockout]] and [[temporary-power|Temporary Power]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-10}}

## When this applies

- You are planning or supervising electrical work, maintenance, temporary power changes, equipment repair, and this topic affects the task. {{cite:ohsr-part-19}}
- The work could involve hazards or outcomes such as electrical shock, stored energy, pressure release, unexpected motion, even if the trade or location is different.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-19}}
...
- De-energization/lockout procedure: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-10}}
- Energy source identification: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-19}}
- Verification/test record where required: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-12}}
- Worker training record: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-lockout}}
...
2. Read [[lockout|Lockout]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including electrical shock, stored energy, pressure release, unexpected motion, and identify everyone who could be affected.
