...
Use this page when daily work, hazard reporting, safety participation could involve hazards or outcomes such as unreported hazards, unsafe work, lack of participation. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Worker Rights and Responsibilities usually connects to other site controls, not just one task. Read it with [[refusal-of-unsafe-work|Refusal of Unsafe Work]] and [[site-orientation|Site Orientation]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising daily work, hazard reporting, safety participation, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as unreported hazards, unsafe work, lack of participation, even if the trade or location is different.
...
- A required document such as orientation record must be prepared, reviewed, updated, or kept available.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[young-new-worker-orientation|Young/New Worker Orientation]].
...
- Orientation record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Training record: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Hazard report or refusal record where applicable: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:workers-compensation-act}}
...
2. Read [[refusal-of-unsafe-work|Refusal of Unsafe Work]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including unreported hazards, unsafe work, lack of participation, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including orientation record.
...
- [ ] I know the main hazards: unreported hazards, unsafe work, lack of participation.
