...
Use this page when general construction, concrete work, demolition, excavation, material handling could involve hazards or outcomes such as crush injury, puncture, slips, chemical exposure, poor traction. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Safety Footwear usually connects to other site controls, not just one task. Read it with [[ppe-basics|PPE Basics]] and [[material-handling|Material Handling]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising general construction, concrete work, demolition, excavation, material handling, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as crush injury, puncture, slips, chemical exposure, poor traction, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[housekeeping|Housekeeping]].
...
- Task-specific footwear procedure where required: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ppe}}
...
- Inspection or pre-use check record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:ohsr-part-8}}
- Corrective action record when a deficiency is found: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-ohs-regulation}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[ppe-basics|PPE Basics]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including crush injury, puncture, slips, chemical exposure, poor traction, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[concrete-formwork|Concrete Formwork]] and assign a separate corrective action.
