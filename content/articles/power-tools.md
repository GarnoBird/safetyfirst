...
Use this page when cutting, grinding, drilling, fastening, demolition could involve hazards or outcomes such as cuts, kickback, flying debris, dust, noise, electric shock. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Power Tools usually connects to other site controls, not just one task. Read it with [[eye-and-face-protection|Eye and Face Protection]] and [[hearing-protection|Hearing Protection]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising cutting, grinding, drilling, fastening, demolition, and this topic affects the task. {{cite:ohsr-part-8}}
- The work could involve hazards or outcomes such as cuts, kickback, flying debris, dust, noise, electric shock, even if the trade or location is different.
...
- A required document such as tool inspection checklist where required must be prepared, reviewed, updated, or kept available.
...
- Provide workers with the information, instruction, training, supervision, PPE, and equipment needed for the task. {{cite:ohsr-part-19}}
...
- Use required written plans, procedures, inspections, permits, assessments, or records when the cited source or site condition calls for them. {{cite:ohsr-part-7}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[respirators|Respirators]].
...
- Tool inspection checklist where required: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-12}}
- Manufacturer instructions: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-8}}
- Safe work procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-19}}
- Training/instruction record: shows workers received task-specific instruction before doing the work. {{cite:ohsr-part-7}}
...
- Corrective action record when a deficiency is found: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-8}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[eye-and-face-protection|Eye and Face Protection]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including cuts, kickback, flying debris, dust, noise, electric shock, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including tool inspection checklist where required.
...
- [ ] I know the main hazards: cuts, kickback, flying debris, dust, noise, electric shock.
...
- [ ] If the deficiency points to a broader issue, open [[dust-control-methods|Dust Control Methods]] and assign a separate corrective action.
