...
Use this page when this work could involve hazards or outcomes such as chemical exposure. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

WHMIS Basics usually connects to other site controls, not just one task. Read it with [[respirators|Respirators]] and [[ppe-basics|PPE Basics]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- The work could involve hazards or outcomes such as chemical exposure, even if the trade or location is different.
...
- A required document such as safety data sheets must be prepared, reviewed, updated, or kept available.
...
- Use required written plans, procedures, inspections, permits, assessments, or records when the cited source or site condition calls for them. {{cite:ohsr-part-5}}
...
- Safety data sheets: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-5}}
- Training record: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Safe handling procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-guidelines}}
- Site-specific safe work procedure: shows workers received task-specific instruction before doing the work. {{cite:ohsr-part-5}}
...
2. Read [[respirators|Respirators]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including chemical exposure, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including safety data sheets.
...
- [ ] I know the main hazards: chemical exposure.
