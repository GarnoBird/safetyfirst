...
Use this page when fastening to concrete, fastening to steel, interior construction, formwork fastening could involve hazards or outcomes such as projectile, ricochet, noise, flying debris, misfire. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Powder-Actuated Tools usually connects to other site controls, not just one task. Read it with [[power-tools|Power Tools]] and [[eye-and-face-protection|Eye and Face Protection]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-12}}

## When this applies

- You are planning or supervising fastening to concrete, fastening to steel, interior construction, formwork fastening, and this topic affects the task. {{cite:ohsr-part-8}}
- The work could involve hazards or outcomes such as projectile, ricochet, noise, flying debris, misfire, even if the trade or location is different.
...
- A required document such as operator training record must be prepared, reviewed, updated, or kept available.
- A worker is new to the task, unfamiliar with the site, or unsure which control applies.

## Legal requirements

- Confirm the applicable WorkSafeBC OHS Regulation part, guideline, policy, and any Workers Compensation Act duty before directing the work. {{cite:ohsr-part-12}}
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-8}}
- Provide workers with the information, instruction, training, supervision, PPE, and equipment needed for the task. {{cite:ohsr-part-7}}
...
- Coordinate the work with the prime contractor, employer, supervisor, affected workers, and nearby trades where overlapping work can create hazards. {{cite:ohsr-part-12}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[hearing-protection|Hearing Protection]].
...
- Operator training record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-12}}
- Tool inspection record: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-8}}
- Manufacturer instructions: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-7}}
- Misfire procedure: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Storage/control procedure for loads: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-guidelines}}
- Site-specific safe work procedure: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:ohsr-part-12}}
- Worker instruction or training record: gives the crew a reference point when conditions change mid-shift. {{cite:ohsr-part-8}}
- Inspection or pre-use check record: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-7}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[power-tools|Power Tools]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including projectile, ricochet, noise, flying debris, misfire, and identify everyone who could be affected.
4. Confirm the official source, owner/client requirement, manufacturer instruction, and site rule that apply. {{cite:ohsr-part-12}}
5. Prepare or update the required document set, including operator training record.
...
- [ ] I know the main hazards: projectile, ricochet, noise, flying debris, misfire.
