...
Use this page when general site work, crane work, demolition, scaffold work could involve hazards or outcomes such as falling objects, head impact, electrical contact, poor fit. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Hard Hats usually connects to other site controls, not just one task. Read it with [[ppe-basics|PPE Basics]] and [[hoarding-and-public-protection|Hoarding and Public Protection]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising general site work, crane work, demolition, scaffold work, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as falling objects, head impact, electrical contact, poor fit, even if the trade or location is different.
...
- Manufacturer instructions: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Inspection/replacement procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ppe}}
...
- Worker instruction or training record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:ohsr-part-8}}
- Inspection or pre-use check record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-ohs-regulation}}
...
3. List the hazards and possible outcomes, including falling objects, head impact, electrical contact, poor fit, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[demolition-planning|Demolition Planning]] and assign a separate corrective action.
