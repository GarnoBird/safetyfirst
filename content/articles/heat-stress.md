...
Use this page when outdoor work, roof work, concrete work, restoration work, ppe-heavy work could involve hazards or outcomes such as heat stress, heat exhaustion, heat stroke, dehydration. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Heat Stress usually connects to other site controls, not just one task. Read it with [[site-emergency-response-plan|Site Emergency Response Plan]] and [[occupational-first-aid-requirements|Occupational First Aid Requirements]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-7}}

## When this applies

- You are planning or supervising outdoor work, roof work, concrete work, restoration work, ppe-heavy work, and this topic affects the task. {{cite:ohsr-part-3}}
- The work could involve hazards or outcomes such as heat stress, heat exhaustion, heat stroke, dehydration, even if the trade or location is different.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-3}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[roof-work|Roof Work]].
...
- Heat stress exposure control plan where required: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-7}}
- Heat stress risk assessment/screening record: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-3}}
- Work-rest/hydration plan: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-32}}
- Emergency response procedure: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-heat-stress}}
- Worker instruction or training record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:bccsa}}
...
- Corrective action record when a deficiency is found: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-7}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[site-emergency-response-plan|Site Emergency Response Plan]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including heat stress, heat exhaustion, heat stroke, dehydration, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[first-aid-assessment|First Aid Assessment]] and assign a separate corrective action.
