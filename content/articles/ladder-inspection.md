...
Use this page when access, short-duration work, inspection before use could involve hazards or outcomes such as falls from height, ladder failure, unstable setup. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Ladder Inspection usually connects to other site controls, not just one task. Read it with [[ladders|Ladders]] and [[fall-protection|Fall Protection]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising access, short-duration work, inspection before use, and this topic affects the task. {{cite:ohsr-part-11}}
- The work could involve hazards or outcomes such as falls from height, ladder failure, unstable setup, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[workplace-inspections|Workplace Inspections]].
...
- Ladder inspection checklist where required by site procedure: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-13}}
- Manufacturer instructions: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-11}}
- Defective ladder removal tag: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-regulation}}
...
- Worker instruction or training record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-workplace-inspections}}
- Inspection or pre-use check record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:ohsr-part-13}}
...
2. Read [[ladders|Ladders]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including falls from height, ladder failure, unstable setup, and identify everyone who could be affected.
