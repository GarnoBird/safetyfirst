...
Use this page when temporary support, concrete work, bridge or slab support, reshoring could involve hazards or outcomes such as collapse, crushing, falling objects, overloading. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Falsework usually connects to other site controls, not just one task. Read it with [[concrete-formwork|Concrete Formwork]] and [[workplace-inspections|Workplace Inspections]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising temporary support, concrete work, bridge or slab support, reshoring, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as collapse, crushing, falling objects, overloading, even if the trade or location is different.
...
- Falsework drawings/specifications where required: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-20}}
- Engineering instructions where required: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Inspection and sign-off record: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-prevention-manual}}
- Load control plan: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-guidelines}}
- Site-specific safe work procedure: keeps the field procedure tied to official sources instead of memory or habit. {{cite:ohsr-part-20}}
- Worker instruction or training record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-ohs-regulation}}
...
3. List the hazards and possible outcomes, including collapse, crushing, falling objects, overloading, and identify everyone who could be affected.
