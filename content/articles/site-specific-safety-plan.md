...
Use this page when project startup, prime contractor coordination, orientation, high-risk work planning could involve hazards or outcomes such as uncoordinated work, missing procedures, uncontrolled high-risk tasks, poor emergency planning. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Site-Specific Safety Plan usually connects to other site controls, not just one task. Read it with [[prime-contractor-duties|Prime Contractor Duties]] and [[ohs-program|OHS Program]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising project startup, prime contractor coordination, orientation, high-risk work planning, and this topic affects the task. {{cite:ohsr-part-20}}
- The work could involve hazards or outcomes such as uncoordinated work, missing procedures, uncontrolled high-risk tasks, poor emergency planning, even if the trade or location is different.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-20}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[site-orientation|Site Orientation]].
...
- Site-specific safety plan: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Emergency response plan: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-20}}
- First aid assessment: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-32}}
- Traffic/public protection plans where required: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- High-risk work plans and permits: keeps the field procedure tied to official sources instead of memory or habit. {{cite:workers-compensation-act}}
- Inspection and corrective action records: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-rights-responsibilities}}
...
- Worker instruction or training record: creates evidence for the next scheduled safety/source review. {{cite:worksafebc-ohs-guidelines}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[prime-contractor-duties|Prime Contractor Duties]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including uncoordinated work, missing procedures, uncontrolled high-risk tasks, poor emergency planning, and identify everyone who could be affected.
