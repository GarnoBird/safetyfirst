...
Use this page when rebar installation, concrete work, formwork, deck work could involve hazards or outcomes such as impalement, puncture injury, falls onto projections, struck-by. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Rebar Impalement Protection usually connects to other site controls, not just one task. Read it with [[concrete-formwork|Concrete Formwork]] and [[floor-openings-and-covers|Floor Openings and Covers]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising rebar installation, concrete work, formwork, deck work, and this topic affects the task. {{cite:ohsr-part-4}}
- The work could involve hazards or outcomes such as impalement, puncture injury, falls onto projections, struck-by, even if the trade or location is different.
...
- Rebar hazard assessment: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-20}}
- Impalement protection plan or checklist: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-4}}
- Inspection record: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-11}}
- Corrective action log: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-rebar-bulletin}}
- Worker instruction or training record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-workplace-inspections}}
...
- Corrective action record when a deficiency is found: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-20}}

## Step-by-step safe procedure

1. Define the exact task, location, workers, equipment, materials, and expected duration.
2. Read [[concrete-formwork|Concrete Formwork]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including impalement, puncture injury, falls onto projections, struck-by, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[workplace-inspections|Workplace Inspections]] and assign a separate corrective action.
