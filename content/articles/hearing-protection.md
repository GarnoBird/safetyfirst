...
hazards:
  ...
  - "Poor fit"
  - "Overprotection/communication issues"
tasks:
  - "Grinding"
  - "Saw cutting"
  - "Demolition"
...
Use this page when grinding, saw cutting, demolition, equipment operation, concrete work could involve hazards or outcomes such as noise-induced hearing loss, poor fit, overprotection/communication issues. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Hearing Protection usually connects to other site controls, not just one task. Read it with [[noise-exposure|Noise Exposure]] and [[site-orientation|Site Orientation]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising grinding, saw cutting, demolition, equipment operation, concrete work, and this topic affects the task. {{cite:ohsr-part-8}}
- The work could involve hazards or outcomes such as noise-induced hearing loss, poor fit, overprotection/communication issues, even if the trade or location is different.
...
- A required document such as noise assessment or task noise information must be prepared, reviewed, updated, or kept available.
...
- Noise assessment or task noise information: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-7}}
- Hearing protection selection record: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-8}}
- Worker instruction record: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-regulation}}
- Hearing test records where required: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-hearing-protection}}
...
2. Read [[noise-exposure|Noise Exposure]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including noise-induced hearing loss, poor fit, overprotection/communication issues, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including noise assessment or task noise information.
...
- [ ] I know the main hazards: noise-induced hearing loss, poor fit, overprotection/communication issues.
...
- [ ] If the deficiency points to a broader issue, open [[ppe-basics|PPE Basics]] and assign a separate corrective action.
