...
Use this page when inspection follow-up, incident follow-up, hazard correction could involve hazards or outcomes such as repeat incidents, unclosed deficiencies, paper-only safety. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Corrective Actions usually connects to other site controls, not just one task. Read it with [[workplace-inspections|Workplace Inspections]] and [[incident-investigation|Incident Investigation]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising inspection follow-up, incident follow-up, hazard correction, and this topic affects the task. {{cite:ohsr-part-4}}
- The work could involve hazards or outcomes such as repeat incidents, unclosed deficiencies, paper-only safety, even if the trade or location is different.
...
- Corrective action log: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Inspection or incident reference: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-4}}
- Close-out evidence: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-regulation}}
- Supervisor verification: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-workplace-inspections}}
...
3. List the hazards and possible outcomes, including repeat incidents, unclosed deficiencies, paper-only safety, and identify everyone who could be affected.
