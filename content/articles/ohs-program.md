...
Use this page when program setup, site safety planning, employer safety management could involve hazards or outcomes such as unmanaged hazards, missing records, inconsistent supervision. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

OHS Program usually connects to other site controls, not just one task. Read it with [[employer-duties|Employer Duties]] and [[supervisor-duties|Supervisor Duties]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising program setup, site safety planning, employer safety management, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as unmanaged hazards, missing records, inconsistent supervision, even if the trade or location is different.
...
- A required document such as ohs program must be prepared, reviewed, updated, or kept available.
...
- OHS program: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Written safe work procedures: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Inspection schedule: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:workers-compensation-act}}
- Training matrix: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-rights-responsibilities}}
- Incident investigation process: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-guidelines}}
- Emergency and first aid procedures: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:ohsr-part-3}}
...
- Worker instruction or training record: creates evidence for the next scheduled safety/source review. {{cite:workers-compensation-act}}
...
3. List the hazards and possible outcomes, including unmanaged hazards, missing records, inconsistent supervision, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including ohs program.
...
- [ ] I know the main hazards: unmanaged hazards, missing records, inconsistent supervision.
