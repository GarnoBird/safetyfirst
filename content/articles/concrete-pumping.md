...
Use this page when concrete placing, pump setup, line cleaning, boom operation could involve hazards or outcomes such as hose whip, struck-by, power line contact, tipover, line pressure. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Concrete Pumping usually connects to other site controls, not just one task. Read it with [[mobile-equipment|Mobile Equipment]] and [[traffic-control|Traffic Control]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising concrete placing, pump setup, line cleaning, boom operation, and this topic affects the task. {{cite:ohsr-part-16}}
- The work could involve hazards or outcomes such as hose whip, struck-by, power line contact, tipover, line pressure, even if the trade or location is different.
...
- Concrete pump pre-use inspection: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-20}}
- Operator competency/certification record where required: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-16}}
- Pour plan: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-19}}
- Exclusion zone plan: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Traffic or delivery plan: keeps the field procedure tied to official sources instead of memory or habit. {{cite:bccsa}}
...
2. Read [[mobile-equipment|Mobile Equipment]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including hose whip, struck-by, power line contact, tipover, line pressure, and identify everyone who could be affected.
