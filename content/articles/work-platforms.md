...
Use this page when elevated work, scaffold work, interior finishing, exterior work could involve hazards or outcomes such as falls from height, collapse, overloading, poor access. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Work Platforms usually connects to other site controls, not just one task. Read it with [[scaffolds|Scaffolds]] and [[swing-stages|Swing Stages]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising elevated work, scaffold work, interior finishing, exterior work, and this topic affects the task. {{cite:ohsr-part-11}}
- The work could involve hazards or outcomes such as falls from height, collapse, overloading, poor access, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[mobile-elevating-work-platforms|Mobile Elevating Work Platforms]].
...
- Platform inspection record: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-13}}
...
- Load rating information: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-4}}
- Fall protection plan where required: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
...
- Worker instruction or training record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:ohsr-part-13}}
...
3. List the hazards and possible outcomes, including falls from height, collapse, overloading, poor access, and identify everyone who could be affected.
...
- [ ] If the deficiency points to a broader issue, open [[guardrails|Guardrails]] and assign a separate corrective action.
