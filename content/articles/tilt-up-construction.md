...
Use this page when panel casting, panel lifting, temporary bracing, crane pick could involve hazards or outcomes such as panel collapse, crushing, dropped load, crane hazards, wind loading. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Tilt-Up Construction usually connects to other site controls, not just one task. Read it with [[cranes-and-hoists|Cranes and Hoists]] and [[rigging-basics|Rigging Basics]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising panel casting, panel lifting, temporary bracing, crane pick, and this topic affects the task. {{cite:ohsr-part-14}}
- The work could involve hazards or outcomes such as panel collapse, crushing, dropped load, crane hazards, wind loading, even if the trade or location is different.
...
- Tilt-up erection plan: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-20}}
- Engineering drawings and brace details: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-14}}
- Lift plan: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-16}}
- Panel inspection record: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Exclusion zone plan: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-guidelines}}
- Site-specific safe work procedure: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:bccsa}}
...
- Inspection or pre-use check record: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-14}}
...
3. List the hazards and possible outcomes, including panel collapse, crushing, dropped load, crane hazards, wind loading, and identify everyone who could be affected.
