...
Use this page when temporary heating, generator use, equipment operation indoors, parkade work could involve hazards or outcomes such as carbon monoxide poisoning, oxygen displacement, confined/poorly ventilated spaces. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Carbon Monoxide usually connects to other site controls, not just one task. Read it with [[ventilation|Ventilation]] and [[confined-space-entry|Confined Space Entry]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-5}}

## When this applies

- You are planning or supervising temporary heating, generator use, equipment operation indoors, parkade work, and this topic affects the task. {{cite:ohsr-part-9}}
- The work could involve hazards or outcomes such as carbon monoxide poisoning, oxygen displacement, confined/poorly ventilated spaces, even if the trade or location is different.
...
- A required document such as carbon monoxide exposure control plan where required must be prepared, reviewed, updated, or kept available.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-9}}
...
- Coordinate the work with the prime contractor, employer, supervisor, affected workers, and nearby trades where overlapping work can create hazards. {{cite:worksafebc-carbon-monoxide}}
...
- Carbon monoxide exposure control plan where required: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-5}}
- Air monitoring record: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-9}}
- Ventilation plan: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-20}}
- Equipment maintenance record: shows workers received task-specific instruction before doing the work. {{cite:ohsr-part-32}}
- Worker instruction record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-carbon-monoxide}}
...
2. Read [[ventilation|Ventilation]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including carbon monoxide poisoning, oxygen displacement, confined/poorly ventilated spaces, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including carbon monoxide exposure control plan where required.
...
- [ ] I know the main hazards: carbon monoxide poisoning, oxygen displacement, confined/poorly ventilated spaces.
...
- [ ] The article and official sources have been checked for this task. {{cite:ohsr-part-9}}
...
- {{cite:worksafebc-carbon-monoxide}}
- {{cite:bccsa}}
