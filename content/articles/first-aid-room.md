...
Use this page when first aid setup, emergency response, site layout planning could involve hazards or outcomes such as delayed treatment, blocked access, missing supplies. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

First Aid Room usually connects to other site controls, not just one task. Read it with [[occupational-first-aid-requirements|Occupational First Aid Requirements]] and [[first-aid-assessment|First Aid Assessment]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising first aid setup, emergency response, site layout planning, and this topic affects the task. {{cite:worksafebc-ohs-regulation}}
- The work could involve hazards or outcomes such as delayed treatment, blocked access, missing supplies, even if the trade or location is different.
...
- A required document such as first aid assessment must be prepared, reviewed, updated, or kept available.
...
- Provide workers with the information, instruction, training, supervision, PPE, and equipment needed for the task. {{cite:worksafebc-first-aid-requirements}}
...
- Stop and reassess the work when conditions no longer match the plan, a control is missing, or a worker reports an unsafe condition. {{cite:ohsr-part-3}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[emergency-transportation|Emergency Transportation]].
...
- First aid assessment: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- First aid room inspection checklist: confirms the site condition was checked before the crew started work. {{cite:worksafebc-ohs-regulation}}
- Supply inventory: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-first-aid-requirements}}
- Emergency access map: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-guidelines}}
- Site-specific safe work procedure: keeps the field procedure tied to official sources instead of memory or habit. {{cite:ohsr-part-3}}
...
2. Read [[occupational-first-aid-requirements|Occupational First Aid Requirements]] and the site procedure before setting up the work.
3. List the hazards and possible outcomes, including delayed treatment, blocked access, missing supplies, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including first aid assessment.
...
- [ ] I know the main hazards: delayed treatment, blocked access, missing supplies.
...
- [ ] If the deficiency points to a broader issue, open [[cardiac-arrest-on-site|Cardiac Arrest on Site]] and assign a separate corrective action.
