...
Use this page when decking, concrete work, formwork, demolition, roof work could involve hazards or outcomes such as falls through openings, falling objects, unmarked covers. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Floor Openings and Covers usually connects to other site controls, not just one task. Read it with [[fall-protection|Fall Protection]] and [[guardrails|Guardrails]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising decking, concrete work, formwork, demolition, roof work, and this topic affects the task. {{cite:ohsr-part-11}}
- The work could involve hazards or outcomes such as falls through openings, falling objects, unmarked covers, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[leading-edge-work|Leading Edge Work]].
...
- Opening inventory or location mark-up: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-4}}
- Cover or guardrail inspection record: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-11}}
- Fall protection plan where required: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-20}}
...
3. List the hazards and possible outcomes, including falls through openings, falling objects, unmarked covers, and identify everyone who could be affected.
