...
- The work can expose workers, nearby trades, visitors, tenants, pedestrians, traffic, or the public to missed task hazards, poor communication, routine drift.
...
1. Define how toolbox talks connects to today's work area, task, crew, and equipment.
2. Read the related article that carries the closest legal or high-risk control before relying on this page alone.
3. Identify the likely hazards, including missed task hazards, poor communication, routine drift, and who could be affected.
4. Confirm the official source, site rule, or procedure that applies to the work. {{cite:ohsr-part-3}}
5. Prepare or update Toolbox talk record and any supporting record that the site requires.
...
- [ ] I understand how toolbox talks affects my task today.
- [ ] I know the likely hazards, including missed task hazards, poor communication, routine drift.
- [ ] I know the control that must be in place before I start.
- [ ] I know where Toolbox talk record or the related site procedure is kept.
...
- [ ] The topic has been checked against current source notes for Toolbox Talks.
