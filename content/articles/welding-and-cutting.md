...
Use this page when hot work, steel work, demolition, repair work, fabrication could involve hazards or outcomes such as fire, explosion, fumes, burns, arc flash, compressed gas. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Welding and Cutting usually connects to other site controls, not just one task. Read it with [[hot-work|Hot Work]] and [[fire-extinguishers|Fire Extinguishers]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising hot work, steel work, demolition, repair work, fabrication, and this topic affects the task. {{cite:ohsr-part-5}}
- The work could involve hazards or outcomes such as fire, explosion, fumes, burns, arc flash, compressed gas, even if the trade or location is different.
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[compressed-gas-cylinders|Compressed Gas Cylinders]].
...
- Fire watch assignment: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-5}}
- Ventilation/exposure control procedure: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-8}}
- Cylinder handling procedure: shows workers received task-specific instruction before doing the work. {{cite:ohsr-part-19}}
- PPE requirements: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-hot-work-fire}}
...
- Inspection or pre-use check record: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-12}}
...
3. List the hazards and possible outcomes, including fire, explosion, fumes, burns, arc flash, compressed gas, and identify everyone who could be affected.
