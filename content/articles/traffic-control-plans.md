...
Use this page when road work, deliveries, lane closure, public interface, site logistics could involve hazards or outcomes such as vehicle strike, pedestrian conflict, public interface, mobile equipment. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Traffic Control Plans usually connects to other site controls, not just one task. Read it with [[traffic-control|Traffic Control]] and [[traffic-control-persons|Traffic Control Persons]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising road work, deliveries, lane closure, public interface, site logistics, and this topic affects the task. {{cite:ohsr-part-16}}
- The work could involve hazards or outcomes such as vehicle strike, pedestrian conflict, public interface, mobile equipment, even if the trade or location is different.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-16}}
...
- Stop and reassess the work when conditions no longer match the plan, a control is missing, or a worker reports an unsafe condition. {{cite:worksafebc-traffic-training}}
...
- Traffic control plan: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-18}}
- Traffic control layout: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-16}}
- TCP training records: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-20}}
- Inspection/review record: shows workers received task-specific instruction before doing the work. {{cite:worksafebc-ohs-regulation}}
- Permit or municipal requirements where applicable: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-traffic-training}}
...
- Worker instruction or training record: gives the crew a reference point when conditions change mid-shift. {{cite:ohsr-part-18}}
- Inspection or pre-use check record: creates evidence for the next scheduled safety/source review. {{cite:ohsr-part-16}}
...
3. List the hazards and possible outcomes, including vehicle strike, pedestrian conflict, public interface, mobile equipment, and identify everyone who could be affected.
...
- [ ] I know the main hazards: vehicle strike, pedestrian conflict, public interface, mobile equipment.
...
- [ ] If the deficiency points to a broader issue, open [[hoarding-and-public-protection|Hoarding and Public Protection]] and assign a separate corrective action.
