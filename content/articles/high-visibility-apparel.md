...
Use this page when traffic control, deliveries, equipment work, night work, public interface could involve hazards or outcomes such as struck-by, vehicle traffic, mobile equipment, poor visibility. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

High Visibility Apparel usually connects to other site controls, not just one task. Read it with [[traffic-control|Traffic Control]] and [[traffic-control-persons|Traffic Control Persons]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.

This is a source-cited draft, not a legal opinion. Legal points include citations where possible; anything marked source review needed must be checked by a qualified BC safety/source reviewer before it is used as a compliance checklist. {{cite:ohsr-part-8}}

## When this applies

- You are planning or supervising traffic control, deliveries, equipment work, night work, public interface, and this topic affects the task. {{cite:ohsr-part-18}}
- The work could involve hazards or outcomes such as struck-by, vehicle traffic, mobile equipment, poor visibility, even if the trade or location is different.
...
- A required document such as ppe requirement in site orientation must be prepared, reviewed, updated, or kept available.
...
- Identify the hazards connected to this work and control them before workers are exposed. {{cite:ohsr-part-18}}
- Provide workers with the information, instruction, training, supervision, PPE, and equipment needed for the task. {{cite:ohsr-part-16}}
...
- Stop and reassess the work when conditions no longer match the plan, a control is missing, or a worker reports an unsafe condition. {{cite:worksafebc-ppe}}
...
- Before work starts, walk the area with the crew and check whether today's setup also needs controls covered in [[mobile-equipment|Mobile Equipment]].
...
- PPE requirement in site orientation: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-8}}
- Traffic control plan where required: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-18}}
- Worker instruction record: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:ohsr-part-16}}
...
- Worker instruction or training record: keeps the field procedure tied to official sources instead of memory or habit. {{cite:worksafebc-ppe}}
- Inspection or pre-use check record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:worksafebc-ohs-guidelines}}
...
3. List the hazards and possible outcomes, including struck-by, vehicle traffic, mobile equipment, poor visibility, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including ppe requirement in site orientation.
...
- [ ] I know the main hazards: struck-by, vehicle traffic, mobile equipment, poor visibility.
...
- [ ] The article and official sources have been checked for this task. {{cite:ohsr-part-18}}
...
- [ ] If the deficiency points to a broader issue, open [[traffic-control-plans|Traffic Control Plans]] and assign a separate corrective action.
