...
Use this page when emergency response, first aid response could involve hazards or outcomes such as medical emergency, cardiac arrest. It gives supervisors and crews a plain-language starting point for the controls, documents, and stop-work triggers that should be checked before work starts.

Cardiac Arrest on Site usually connects to other site controls, not just one task. Read it with [[occupational-first-aid-requirements|Occupational First Aid Requirements]] and [[site-emergency-response-plan|Site Emergency Response Plan]] when planning the work, especially if access, weather, equipment, public protection, or nearby trades could change the risk.
...
- You are planning or supervising emergency response, first aid response, and this topic affects the task. {{cite:ohsr-part-32}}
- The work could involve hazards or outcomes such as medical emergency, cardiac arrest, even if the trade or location is different.
...
- A required document such as written first aid procedures must be prepared, reviewed, updated, or kept available.
...
- Use required written plans, procedures, inspections, permits, assessments, or records when the cited source or site condition calls for them. {{cite:heart-stroke-cpr}}
...
- Written first aid procedures: defines the control, location, responsible person, and review trigger. {{cite:ohsr-part-3}}
- Emergency response plan: confirms the site condition was checked before the crew started work. {{cite:ohsr-part-32}}
- First aid record: supports follow-up if there is a deficiency, refusal, incident, or source-review question. {{cite:worksafebc-ohs-regulation}}
- Site-specific safe work procedure: shows workers received task-specific instruction before doing the work. {{cite:heart-stroke-cpr}}
...
- Inspection or pre-use check record: helps employers, the prime contractor, and affected trades coordinate overlapping work. {{cite:ohsr-part-3}}
...
3. List the hazards and possible outcomes, including medical emergency, cardiac arrest, and identify everyone who could be affected.
...
5. Prepare or update the required document set, including written first aid procedures.
...
- [ ] I know the main hazards: medical emergency, cardiac arrest.
