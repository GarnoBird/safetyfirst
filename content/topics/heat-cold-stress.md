...
Heat/cold stress covers practical jobsite controls for outdoor or indoor work where temperature, humidity, wind, workload, clothing, or exposure time can affect workers. This page is written for field use and does not replace WorkSafeBC, BC law, engineered documents, manufacturer instructions, or site-specific procedures.
