...
Supervisor duties covers practical jobsite controls for field supervision duties for instruction, hazard control, monitoring, correction, and documentation. This page is written for field use and does not replace WorkSafeBC, BC law, engineered documents, manufacturer instructions, or site-specific procedures.
