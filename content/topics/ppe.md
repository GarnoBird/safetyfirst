...
PPE covers practical jobsite controls for selection, use, inspection, storage, and replacement of personal protective equipment. This page is written for field use and does not replace WorkSafeBC, BC law, engineered documents, manufacturer instructions, or site-specific procedures.
...
- Incorrect PPE
- Damaged PPE
- PPE used instead of stronger controls
- Poor fit
