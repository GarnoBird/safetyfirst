...
Refusing unsafe work covers practical jobsite controls for worker refusal process when a worker believes work would create undue hazard. This page is written for field use and does not replace WorkSafeBC, BC law, engineered documents, manufacturer instructions, or site-specific procedures.
