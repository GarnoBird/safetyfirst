...
function articleFromMarkdown(path, content) {
  ...
  return {
    ...
    prepStatus: frontmatter.prepStatus || "Needs AI prep",
    prepReviewedDate: frontmatter.prepReviewedDate || "",
    prepReviewTier: frontmatter.prepReviewTier || frontmatter.reviewTier || workflow.reviewTier,
    prepNotes: toArray(frontmatter.prepNotes),
    reviewQuestions: toArray(frontmatter.reviewQuestions),
    aliases: frontmatter.aliases || [],
    trades: frontmatter.trades || ["All construction trades"],
    hazards: frontmatter.hazards || [],
    tasks: frontmatter.tasks || [],
    ...
    humanReviewQuestions: listItems(section(markdown, "What a human reviewer must verify")),
    review: {
